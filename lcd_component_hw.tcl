...
# Componente que fornece a interface em hardware para a instrução customizada de exibição no lcd
# 
...
# 
set_module_property DESCRIPTION "Componente que fornece a interface em hardware para a instrução customizada de exibição no lcd"
